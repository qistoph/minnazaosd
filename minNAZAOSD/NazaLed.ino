...
Ziel: Erkennung folgender Modi:
	...
	FS 	FailSafe	gelb gelb gelb gelb gelb gelb gelb gelb gelb gelb gelb ... kein grön
	'record home point'	ca.3000ms grön grön grön grön grön grön grön grön grön ... kein gelb

Umsetzung:
	- Wenn 3 Sekunden lang kein gelb oder gr�n		--> MAN
	- Wenn gelb oder gr�n steigende Flanke erkannt, dann
	  Timer starten und steigende gelb und gr�n Flanken z�hlen.
	  Nach 1 Sekunde Anzahl der Flanken auswerten:
		gelb = 1 oder 2 und gr�n = 0			--> ATT
		gr�n = 1 oder 2 und gelb = 0			--> GPS
		gelb = 1 und gr�n = 1 oder 2			--> IOC
		gelb > 3					--> FS
		gr�n > 3 und ca. 3000ms lang			--> 'record home point' evtl. erkannt
